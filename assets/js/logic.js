...
let mode = 'dark';
let logicBody = document.querySelector('.dark_body');
...
handleThemeSwitch = function (event) {
    ...
    if (mode === 'dark') {
        ...
        logicBody = document.querySelector('.dark_body');
        ...
        logicBody.setAttribute('class', 'light_body');
        ...
        mode = 'dark';
        logicBody = document.querySelector('.light_body');
        ...
        logicBody.setAttribute('class', 'dark_body');
